...
def reader_histroy():
    ...
    return render_template('reader_history.html', histroys=histroys)
...
"""
1模板使用  基础模板layout.html
2进入程序显示首页  index.html
3管理员登录 mamager_login.html  GET POST 
4登录管理员之后 manager.html 
管理员登出之后 回到首页
5管理员点击图书管理之后会 manager_books.html
图书管理返回 到 manager.html 
6图书管理添加 到manager_books_add.html GET POST
添加成功之后返回到manager_books.html
7图书管理删除 到manager_books_delete.html 页面
8查看图书信息 到manager_book.html 页面
9查看图书信息修改到 manager_modify.html页面 GET POST


10 用户注册 到register.html 页面GET POST
11 用户注册成功 到 reader_login.html  页面 GET POST
12 用户登录成功 到 reader.html
13 用户查询到reader_query.html
14 查看书籍信息 到reader_book.html
借阅 post reader_book

15 查看个人信息 到 reader_info.html
16 修改跟人信息 到reader_modify.html

17 查看借阅历史 到reader_histroy.html


用户注册之后 才有的功能
18管理员登录 用户管理到manager_users.html 页面
19用户信息进入manager_userinfo.html
20用户信息修改进入manager_user_modify.html页面
注销用户返回manager_users.html 页面
"""
